      ...
      {orderDetails.paymentMethod === "CARD" ? (
        ...
        <div>
          ...
          <select
            ...
            required
          >
            <option value="" className="bg-white dark:bg-[#1a1816]">
              Choose a bank
            </option>
            <option value="maybank2u" className="bg-white dark:bg-[#1a1816]">
              Maybank2U
            </option>
            <option value="cimb" className="bg-white dark:bg-[#1a1816]">
              CIMB Clicks
            </option>
            <option value="public_bank" className="bg-white dark:bg-[#1a1816]">
              Public Bank
            </option>
            <option value="rhb" className="bg-white dark:bg-[#1a1816]">
              RHB Bank
            </option>
            <option
              value="hong_leong_bank"
              className="bg-white dark:bg-[#1a1816]"
            >
              Hong Leong Bank
            </option>
            <option value="ambank" className="bg-white dark:bg-[#1a1816]">
              AmBank
            </option>
            <option value="affin_bank" className="bg-white dark:bg-[#1a1816]">
              Affin Bank
            </option>
            <option
              value="alliance_bank"
            ...
            <option value="bank_islam" className="bg-white dark:bg-[#1a1816]">
              Bank Islam
            </option>
            <option
              value="bank_muamalat"
            ...
            <option value="bank_rakyat" className="bg-white dark:bg-[#1a1816]">
              Bank Rakyat
            </option>
            <option value="bsn" className="bg-white dark:bg-[#1a1816]">
              BSN
            </option>
            <option value="hsbc" className="bg-white dark:bg-[#1a1816]">
              HSBC Bank
            </option>
            <option value="kfh" className="bg-white dark:bg-[#1a1816]">
              Kuwait Finance House
            </option>
            <option value="ocbc" className="bg-white dark:bg-[#1a1816]">
              OCBC Bank
            </option>
            <option
            ...
            <option value="uob" className="bg-white dark:bg-[#1a1816]">
              UOB
            </option>
          </select>
        </div>
    ...
    return (
      <div className="min-h-screen bg-[#f9f7f2] dark:bg-[#1a1816] flex items-center justify-center p-8">
        <div className="bg-white dark:bg-[#2d2a27] rounded-2xl p-12 text-center max-w-md shadow-xl">
          ...
          <h1 className="text-3xl font-black mb-4 text-[#3e3a36] dark:text-white">
            Payment Successful!
          </h1>
      ...
      <div className="min-h-screen bg-[#f9f7f2] dark:bg-[#1a1816] flex items-center justify-center p-8">
        <div className="bg-white dark:bg-[#2d2a27] rounded-2xl p-8 max-w-md w-full shadow-xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black mb-2 text-[#3e3a36] dark:text-white">
              Complete Payment
            </h1>
            ...
            <p className="text-lg font-bold mt-2">
              Total: RM{orderDetails.total.toFixed(2)}
            </p>
          </div>
